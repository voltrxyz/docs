...
For additional support, refer to the [Ranger Earn SDK documentation](https://ranger-finance.github.io/vault-sdk/) or [example scripts](https://github.com/voltrxyz/client-scripts).
