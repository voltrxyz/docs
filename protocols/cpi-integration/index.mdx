...
<Tip>
Building with a coding agent? The [Voltr Agent Skill](/explore/agent-skill) ships a `cpi-integration.md` reference with verified discriminators and drop-in Rust CPI wrappers for all five vault instructions in `examples/cpi/`.
</Tip>
